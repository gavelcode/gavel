...
func TestFindingFinderListByFile(t *testing.T) {
	...
	items, err := finder.ListByFile(ctx, caseFile.ID().String(), "src/Foo.java")
...
func TestFindingFinderListByFileEmpty(t *testing.T) {
	...
	items, err := finder.ListByFile(ctx, caseFile.ID().String(), "nonexistent.java")
	require.NoError(t, err)
...
func TestRepoFindByIDErrorOnCancelledContext(t *testing.T) {
	...
	_, err := repo.FindByID(ctx, caseFile.ID())
	assert.Error(t, err)
}
...
func TestFindingFinderListReturnsErrorOnDataQueryFailure(t *testing.T) {
	...
	_, _, err = finder.List(ctx, filters, 10, 0)
	assert.Error(t, err)
}
...
func TestFindingFinderListByFileReturnsErrorOnQueryFailure(t *testing.T) {
	...
	_, err = finder.ListByFile(ctx, "00000000-0000-0000-0000-000000000000", "src/Main.java")
	assert.Error(t, err)
...
func TestCaseFileFinderGetByIDReturnsErrorOnEvidenceQueryFailure(t *testing.T) {
	...
	_, err = finder.GetByID(ctx, caseFile.ID().String())
	assert.Error(t, err)
}
...
func TestFindingFinderListReturnsErrorOnCountFailure(t *testing.T) {
	...
	_, _, err := finder.List(ctx, findinglist.Filters{}, 10, 0)
	assert.Error(t, err)
...
func TestCaseFileFinderListByProjectWithGavelspaceFilter(t *testing.T) {
	...
	items, total, err := finder.ListByProject(ctx, project.ID().String(), "test-gs", 10, 0)
	require.NoError(t, err)
	assert.GreaterOrEqual(t, total, 1)
	assert.GreaterOrEqual(t, len(items), 1)
}
...
func TestCaseFileFinderListByProjectShowsCoveragePercent(t *testing.T) {
	...
	items, _, err := finder.ListByProject(ctx, project.ID().String(), "", 10, 0)
	require.NoError(t, err)
...
func TestCaseFileFinderGetByIDReturnsNotFoundForMissingCaseFile(t *testing.T) {
	...
	_, err := finder.GetByID(ctx, "00000000-0000-0000-0000-999999999999")
	assert.Error(t, err)
...
func TestCaseFileFinderGetByIDReturnsErrorOnCancelledContext(t *testing.T) {
	...
	_, err := finder.GetByID(ctx, "00000000-0000-0000-0000-000000000000")
	assert.Error(t, err)
}
